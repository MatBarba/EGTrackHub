...
my $trackHubCreator_obj = TrackHubCreation->new($study_id, $tmpdir);

isa_ok($trackHubCreator_obj,'TrackHubCreation','the object constructed is of my class type');
dies_ok(sub{TrackHubCreation->new($study_dir)},'Construction from wrong object should die');
...
my $return1=TrackHubCreation->make_hubtxt_file($tmpdir, $study_obj);
...
my $ena_biorep_title = TrackHubCreation::get_ENA_biorep_title($study_obj, $biorep_id);
