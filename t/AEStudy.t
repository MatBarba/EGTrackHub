...
my $study_obj=EGTH::AEStudy->new("SRP068911",$plant_names_response_href);

# test5
isa_ok($study_obj,'EGTH::AEStudy','checks whether the object constructed is of my class type');

# test6
dies_ok(sub{EGTH::AEStudy->new("blabla")},'checks if wrong object construction of my class dies');
...
my $study_obj_3_assemblies=EGTH::AEStudy->new("DRP000453",$plant_names_response_href); # see http://plantain:3000/json/70/getRunsByStudy/DRP000453
...
#test15
my $study_obj_with_many_samples_per_biorep_id=EGTH::AEStudy->new("SRP002106",$plant_names_response_href);
...
#test35
my $study_obj_SRP067728=EGTH::AEStudy->new("SRP067728",$plant_names_response_href);
