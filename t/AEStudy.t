...
my $oryza_biorep = $study_3_assemblies->get_biorep_ids_by_organism("oryza_sativa");
...
my $oryza_sativa_study_with_many_assemblies_number_of_bioreps = scalar keys %$oryza_biorep;
...
#test17
my $assembly_name = $study_with_many_samples_per_biorep_id->get_assembly_name_from_biorep_id("E-GEOD-16631.biorep2");
...
#test18
my @sample_ids_aref=$study_with_many_samples_per_biorep_id->get_sample_ids_from_biorep_id("E-GEOD-16631.biorep2"); # see http://plantain:3000/json/70/getRunsByStudy/SRP002106
...
my $biorep_ids_from_sample_id_href = $study_with_many_samples_per_biorep_id->get_biorep_ids_from_sample_id("SAMN00009808");
...
ok(exists $assembly_names_of_study_href->{"ASM465v1"} ,  "Assembly id \'ASM465v1\' of study ".$study_3_assemblies->id." exists at the moment" );

#test24
ok(exists $assembly_names_of_study_href->{"IRGSP-1.0"} ,  "Assembly id \'IRGSP-1.0\' of study ".$study_3_assemblies->id." exists at the moment" );

#test25
ok(exists $assembly_names_of_study_href->{"OR_W1943"} ,  "Assembly id \'OR_W1943\' of study ".$study_3_assemblies->id." exists at the moment" );
...
my $file_location=$study_3_assemblies->get_big_data_file_location_from_biorep_id("DRR001371");
...
#test27
dies_ok(sub{$study_3_assemblies->get_big_data_file_location_from_biorep_id("E-GEOD-16631.biorep2")},'checks if wrong biorep id of study dies');
...
my $last_processed_date_AE_from_biorep_id=$study_3_assemblies->get_AE_last_processed_date_from_biorep_id("DRR001371");
like($last_processed_date_AE_from_biorep_id , qr/[\w{3}\s\w{2}\s20\w{2}\s.+]/, "Last AE processed date is as expected");

#test29
dies_ok(sub{$study_3_assemblies->get_AE_last_processed_date_from_biorep_id("E-GEOD-16631.biorep2")},'checks if wrong biorep id of study dies');
...
my $runs_ids_aref =$study_with_many_samples_per_biorep_id->get_run_ids_of_biorep_id("E-GEOD-16631.biorep2");
...
#test32
dies_ok(sub{$study_with_many_samples_per_biorep_id->get_run_ids_of_biorep_id("DRR001371")},'checks if wrong biorep id of study dies');
...
#test33
my $file_type =$study_with_many_samples_per_biorep_id->give_big_data_file_type_of_biorep_id("E-GEOD-16631.biorep2");
is($file_type, "cram" , "file type is currently cram as expected");

#test34
dies_ok(sub{$study_with_many_samples_per_biorep_id->give_big_data_file_type_of_biorep_id("DRR001371")},'checks if wrong biorep id of study dies');
